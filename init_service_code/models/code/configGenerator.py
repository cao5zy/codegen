...
class ConfigGenerator:
    ...
    def gen(self):
        ...
        return "{" + ",\n".join(
            list(map(lambda n:'''"%s": "%s"''' % (n.name, n.value), filter(lambda n:isinstance(n.value, str) or isinstance(n.value, str), defaultConfig.dependedServers + defaultConfig.configs))) +\
